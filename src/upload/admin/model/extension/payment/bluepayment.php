...
{
    const VERSION = BluepaymentDictionary::EXTENSION_VERSION;

    const CONFIG_CODE = 'bluepayment';
    const VERSION_CONFIG_KEY = 'bluepayment_version';
    ...
    public function install()
    {
        ...
        $this->model_setting_setting->editSetting(self::CONFIG_CODE, [
            ...
            'bluepayment_status_pending' => ControllerExtensionPaymentBluepayment::STATUS_PENDING,
            'bluepayment_status_failed' => ControllerExtensionPaymentBluepayment::STATUS_FAILED,
            'bluepayment_status_success' => ControllerExtensionPaymentBluepayment::STATUS_PROCESSING,
