...
final class TransactionBuilder
{
    ...
    public function build(array $orderInfo, $serviceId, array $requestParams = [])
    {
    ...
    public function setGatewayId(TransactionStandard $transactionStandard, array $requestParams = [])
    {
